...
except ImportError:  # Airflow exists only in the scheduler image.
    dag = None
else:
    from integrations.airflow.tasks import execute_agent_run
    ...
    with DAG(
        ...
        def execute() -> dict[str, str]:
            ...
            return execute_agent_run(
                agent_run_id=str(conf.get("agent_run_id") or ""),
