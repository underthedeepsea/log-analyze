...
Keep Agent execution single, bounded, and sequential. Do not add autonomous multi-Agent delegation, parallel Agent scheduling, recursive Agent creation, unrestricted shell/network/database tools, or automatic Provider fallback.
